...
val=0,hidden=false,visibility="";if(!$.browser.msie){if($.css($E[0],"display",true)=="none"){hidden=true;visibility=$.css($E[0],"visibility",true);$E.css({display:"block",visibility:"hidden"});}}val=parseInt($.css($E[0],prop,true),10)||0;if(hidden){$E.css({display:"none"});if(visibility&&visibility!="hidden")$E.css({visibility:visibility});}return val;};var cssW=function(e,outerWidth){var $E;if(isStr(e)){e=str(e);$E=$Ps[e];}else
